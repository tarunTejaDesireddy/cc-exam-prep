...
[![Topics](https://img.shields.io/badge/Topics-7-0d2b33?style=for-the-badge)](#-02--the-7-topics)
...
![type](https://img.shields.io/badge/Mostly-definitions%20%26%20metrics-57606A?style=flat-square)
...
|:--:|---|---|
| <sub>&#9745;</sub> | 🧭 [`grc-fundamentals/`](grc-fundamentals/) | Explain why governance, risk and compliance run as one programme. |
...
| <sub>&#9745;</sub> | 🎣 [`security-awareness-training/`](security-awareness-training/) | Tell awareness, training and education apart, and name the social engineering angles. |
| <sub>&#9745;</sub> | 📈 [`measuring-cybersecurity-effectiveness/`](measuring-cybersecurity-effectiveness/) | Tell a KRI from a KPI, and match a dashboard/scorecard/report to its audience. |
