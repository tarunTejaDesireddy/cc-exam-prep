...
```mermaid
flowchart TB
    D1["🖥️ 192.168.1.10<br/>Port 51000"]:::info --> R["📡 Router<br/>203.0.113.45"]:::warn
    D2["📱 192.168.1.20<br/>Port 51500"]:::info --> R
    R --> W1["🌍 203.0.113.45:51000"]:::good
    R --> W2["🌍 203.0.113.45:51500"]:::good
...
```mermaid
flowchart LR
    Table["📋 PAT Translation Table"]:::info --> E1["203.0.113.45:51000<br/>↔ 192.168.1.10"]:::good
    Table --> E2["203.0.113.45:51500<br/>↔ 192.168.1.20"]:::good
...
```mermaid
flowchart TB
    R["📡 Router (PAT)<br/>Public IP: 203.0.113.45"]:::warn --> C1["Employee 1's connection<br/>Port 60001"]:::good
    R --> C2["Employee 2's connection<br/>Port 60002"]:::good
    R --> C3["Employee 3's connection<br/>Port 60003"]:::good
...
```mermaid
flowchart LR
    D["🖥️🖥️🖥️ Many Private Devices"]:::info --> PAT["🔢 PAT<br/>(same IP, different ports)"]:::warn --> Pub["🌐 One Shared Public IP"]:::good
